...
public class Main {
  public static void main(String[] args) {
    ...
    TreeSet<TextDocument> textDocumentSet = new TreeSet<>(Comparator.nullsLast(Comparator.comparing(TextDocument::getAmountSymbols)));
    textDocumentSet.add(new TextDocument("Hello"));
    textDocumentSet.add(new TextDocument("Welcome to the Java world"));
    textDocumentSet.add(new TextDocument("Short"));

    Iterable<TextDocument> textDocuments = textDocumentSet;
